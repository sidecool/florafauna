...
<body>
    ...
    $sql = 'SELECT * FROM tbl_data WHERE judul LIKE :keyword OR deskripsi LIKE :keyword  OR tag LIKE :keyword ORDER BY id DESC ';
					...
					<div class="row">
						...
						<div class="col-lg-4 card">
							<a href="single.php?id=<?php echo $row['id']; ?>">
								<img src="../foto/<?php echo $row['gambar']; ?>" class="card-img-top img-fluid" alt="fantastic cms" style="width: 480px;height: 300px">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> <?php echo $row['tanggal']; ?></a>
									</li>
									<li class="mx-2">
										<a href="#">
											<i class="far fa-user"></i><?php echo $row['judul']; ?></a>
									</li>
									<li>
										<a href="#">
											<i class="fas fa-tags"></i><?php echo $row['tag']; ?></a>
									</li>

								</ul>
								<h5 class="card-title">
									<a href="single.php?id=<?php echo $row['id']; ?>"><?php echo $row['judul']; ?></a>
								</h5>
