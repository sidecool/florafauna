        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                         <h3 class="page-header"> Pengaturan Ujian </h3> 
                ...
                <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        Silakan dilengkapi untuk memudahkan pengguna dalam mengerjakan soal.
                        </div>
...
switch($_GET[act]){
  // Tampil Menuatas
  default:
    $sql  = mysqli_query($connect,"SELECT * FROM tbl_pengaturan_ujian");
    ...
    echo "
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-10'>
              <textarea name='peraturan' style='width: 450px; height: 150px;'>$r[peraturan]</textarea>
            </div>
          </div>
