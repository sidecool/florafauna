...
--
-- Host: localhost:3306
-- Generation Time: Mar 27, 2020 at 11:29 PM
...
(22, 64, '3', '3', '0', '50.0', '2020-03-18', 'Lulus', 'Saya'),
(27, 64, '4', '2', '0', '66.7', '2020-03-20', 'Lulus', 'Rexy'),
(28, 64, '5', '2', '0', '71.4', '2020-03-21', 'Lulus', 'rex');
...
(1, 'Kuis Flora Fauna', '1', '55', '<ol><li>Bacalah dengan teliti tiap-tiap soal sebelum menjawab</li><li>Pengerjaan Soal-soal ujian akan diberikan batasan waktu, apabila waktu telah habis, anda tidak dapat lagi mengisi / mengoreksi kembali jawaban dari soal-soal yang tersedia.&nbsp;<br></li><li>Skor atau nilai hanya akan ditampilkan setelah Anda klik tombol jawab.<br></li><li>Nilai untuk mengetahui kemampuan pemahaman siswa<br></li><li>Percobaan 21 Maret 2020 (Silakan dihapus)</li></ol>');
...
(31, 'Manakah hewan yang tergolong dalam mamalia?<br>', 'Kuda', 'Ayam', 'Hiu', 'Ular', 'a', NULL, '2020-03-21', 'Y', NULL);
...
(1, 'Flora Fauna', 'Belajar tentang hewan dan tumbuhan', '95401600_1524766758.jpg', 'flora, fauna, hewan, tumbuhan', 'Website tentang Flora dan Fauna&nbsp;', 'Website ini untuk memudahkan pembelajaran tentang flora dan fauna 3', 'Merauke, Indonesia', 'info@florafauna.id', '08123456789');
...
--
ALTER TABLE `tbl_nilai`
  MODIFY `id_nilai` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tbl_soal`
  MODIFY `id_soal` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
